...
class rowexp:
    ...
    def multi_ab(self, confalpha, trunctimerange, epsilon = 0, bound_type = 'SubGaussian_LIL', alg_name = 'LUCB', sigma = 4, cauchyn = 0, punif = 0, verbose = 0, improved = 1, precision = 1e-8, control_threshold = float('inf')): # trunctime = max no of pulls
